<%@ Page EnableEventValidation="false" Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="proddetails.aspx.cs" Inherits="shoppingsiteDb.proddetails" %>
                            ...
                            <tr>
                               <td>
                                    <table border="0" style="border-spacing:20px;padding:20px;" >      
                                        ...
                                        <%# Eval("imagename") %>' visible="false" />      
                                            </td>  
                                    <asp:ImageButton ID="prodimg" runat="server" ImageUrl='      
                                        <%# "~/Images/" + Eval("imagename") %>' Height="180px" Width="200px" />      
                                            </td>  
                                           ...
                                           <td  style="padding:20px;" >
                                               <table style="border-spacing:20px;">
                                                   <tr>
                                            <td align="center">      
                                                <asp:Label ID="lblproddescription" runat="server" Text='<%# Eval("productdesc") %>'>      
                                                </asp:Label>      
                                            </td>  
                                                       </tr>
                                            ...
                                            <td align="center">  
                                                <asp:Label ID="lblprodid" runat="server" Text='<%# Eval("productid") %>' visible="false">

                                                </asp:Label>
                                          Price :     <asp:Label ID="lblprodprice" runat="server" Text='<%# Eval("productprice") %>'>      
                                                </asp:Label>  Rs.    
                                            </td> 
                                                       </tr>
