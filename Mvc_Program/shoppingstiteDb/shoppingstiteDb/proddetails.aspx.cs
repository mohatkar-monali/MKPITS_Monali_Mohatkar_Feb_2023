...
namespace shoppingstiteDb
{
    public partial class proddetails : System.Web.UI.Page
    {
        ...
        {
            pid = Request.QueryString["productid"].ToString();
            binddata();
        ...
        public void binddata()
        {
            ...
            string str = "select * from products where productid='" + pid + "'";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection con = new SqlConnection(strcon);
            string str = null;
            str = "select count(*) from ctable3 where productid='" + pid + "' and sessionid='" + Session["sessionid"].ToString() + "' ";
            ...
            {
                str = "update ctable3 set quantity=quantity+1 where productid='" + pid + "' and sessionid='" + Session["sessionid"].ToString() + "'";
